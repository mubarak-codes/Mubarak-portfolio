     ...
     <section className=""> 
      <section className=" container-fluid d-sm-flex d-block mt-4 w-90 align-items-center flex-row-reverse pt-4">
        ...
        <div className="profile-info justify-content-center row py-3 justify-content-sm-start w-90-sm">
         ...
         <a href="files/Mubarak_Owosheni_Resume.pdf" className="row justify-content-center" download><button className="btn bg-success text-white py-2 rounded-4 w-40 text-center ms-2">
            Resume
         </button></a>
        </div>
      </section>
