...
let About = ()=>{
 ...
 return(
  <>
   <section className="flex d-col items-center mt12 px4 px10-sm px19-md px16-lg">
    ...
    <div className="flex d-col d-row-sm gap-5 items-center content-center">
     ...
     <div className="w50-sm w40-lg ">
      ...
      <a href="#contact" className="flex content-center content-start-sm">
       <div className="bg-green b b-trans hover-bg-trans hover-b-green hover-text-green rounded-pill w30 fs2 py2 text-center text-snow fw-semibold opacity100">Contact</div>
      </a>
     </div>
    </div>
   </section>
