   ...
   <section className="mt12 px5 px10-sm px19-md" id="projects">
    ...
    <div className=" gap-4 d-grid gr2-sm">
     {projects.map((project)=>(
      ...
      <div>
        <a href={project.link} className={`fs1 text-green b b-green opacity75 click-fade click-grow link cursor-pointer p1 px2 br2 me20`} target="_blank">Visit Website <i className="bi bi-arrow-up-right vertical-center"></i> </a></div> <hr/>
